...
public class TicketServiceImpl implements TicketService {
    ...
    public TicketInfo create(int trainId, int stationOfDepartureId, int stationOfArrivalId, String firstName, String lastName, LocalDate dateOfBirth, int accountId) {
        ...
        OffsetDateTime datetimeDeparture = presenceDeparture.getInstant().atOffset(ZoneOffset.ofHours(0));
        OffsetDateTime datetimeArrival = presenceArrival.getInstant().atOffset(ZoneOffset.ofHours(0));
    ...
    public TicketInfo getTicketInfo(int ticketId) {
        ...
        ticketInfo.setDatetimeOfDeparture(LocalDateTime.ofInstant(presenceDeparture.getInstant(), ZoneOffset.ofHours(0)));
        ticketInfo.setDatetimeOfArrival(LocalDateTime.ofInstant(presenceArrival.getInstant(), ZoneOffset.ofHours(0)));
